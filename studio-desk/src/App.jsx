        ...
        <header style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between",
          ...
          <div>
            <h1 style={{ display: "flex", alignItems: "center", gap: 10, margin: 0 }}>
              <span style={{ fontSize: 30, fontWeight: 800, letterSpacing: "-0.02em", lineHeight: 1, color: T.ink }}>FOMA</span>
    ...
    <div style={{ minHeight: "100vh", background: T.paper, color: T.ink, fontFamily: SANS,
      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 11, marginBottom: 6 }}>
          <span style={{ fontSize: 28, fontWeight: 800, letterSpacing: "-0.02em", color: T.ink }}>FOMA</span>
          <FomaMark size={26} color={T.accent} />
        </div>
